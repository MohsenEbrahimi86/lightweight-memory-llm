...
class MemorySystem:
    def __init__(self, config_path: str = "configs/config.yaml"):
        ...
        self.store = SimpleJsonStore(store_path=self.config["memory"]["store_path"])
    ...
    def process_conversation(
        ...
        # Extract new facts
        new_memories = self.extractor.extract_facts(conversation, existing_memories)
    ...
    def query_memories(self, query: str, top_k: int = None) -> List[Dict[str, Any]]:
        ...
        relevant_memories = self.retriever.retrieve_memories(query, all_memories, top_k)
